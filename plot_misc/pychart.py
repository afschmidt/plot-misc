...
def pychart(data: pd.DataFrame, columns: List[str],
            ...
            pie_kwargs:Union[None,Dict[Any,Any]]=None,
            annotate_kwargs:Union[None,Dict[Any,Any]]=None,
...
def pychart_grid(df, strat, columns, num_columns=2, figsize=(8, 4),
                 smaller=1, colors=None,
                 pie_kwargs:Union[None, Dict[Any,Any]]=None,
                 annotate_kwargs:Union[None, Dict[Any,Any]]=None,
                 title_kwargs:Union[None, Dict[Any,Any]]=None,
                 subplots_adjust_kwargs:Union[None, Dict[Any,Any]]=None,
                 ):
    """
