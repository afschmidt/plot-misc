...
class Test_format_roc(object):
    '''
    Testing functions for the `format_roc` module
    '''
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    def test_format_roc(self):
        ...
        # assert
        assert res1.mean().round(2).tolist() == [0.33, 0.5, 0.42]
        assert res2.mean().round(2).tolist() == [0.39, 0.7, 0.31]
